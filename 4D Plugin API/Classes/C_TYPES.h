...
// This has already hit multiple projects that include C_TEXT.h (and
// therefore this file) before 4DPlugin-JSON.h, via different upstream
// culprits each time -- guarding it here closes the root cause regardless
// of what else pulls in <windows.h> first.
